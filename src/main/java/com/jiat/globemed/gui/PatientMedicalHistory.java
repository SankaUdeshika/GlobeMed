...
public class PatientMedicalHistory extends javax.swing.JFrame {
    ...
    public PatientMedicalHistory(Patient patient) {
        initComponents();
        this.patientObject = patient;
        jTextArea1.setText(patientObject.getMedicalHistory());
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Patient patient =  new PatientDAO().findById(patientObject.getId());
        patient.setMedicalHistory(jTextArea1.getText());

        new PatientDAO().updatePatient(patient);
        JOptionPane.showMessageDialog(this, "PatientMedical History  Updated");
